...
#    like( $schema->error, qr/no tables/i, '...because there are no tables' );
    ...
    # $schema->add_*
    #
    my $foo_table = SQL::Translator::Object::Table->new({ name => 'foo', schema => $schema });
    $schema->add_table($foo_table) or warn $schema->error;
    isa_ok( $foo_table, 'SQL::Translator::Object::Table', 'Table "foo"' );

    my $bar_table = SQL::Translator::Object::Table->new({ name => 'bar', schema => $schema }) or 
...
#        q[...because "foo" exists] );
    ...
    my $redundant_table = new SQL::Translator::Object::Table({ name => 'foo', schema => $schema });
    ...
    $redundant_table = new SQL::Translator::Object::Table({ name => '', schema => $schema });
...
#        '... because it has no name ' );
    ...
    $redundant_table = SQL::Translator::Object::Table->new({ name => '', schema => $schema });
...
#    like( $schema->error, qr/doesn't exist/, qq[Can't drop non-existant table "foo"] );
    ...
    # Field default new
    #
    my $person_table_column = SQL::Translator::Object::Column->new({ name => 'foo', table => $person_table });
...
#    like( $person_table->error, qr/doesn't exist/, qq[Can't drop non-existant field "f2"] );
    ...
    isa_ok( $index1, 'SQL::Translator::Object::Schema::Index', 'Index' );
    ...
    my $index2 = SQL::Translator::Object::Schema::Index->new( name => "bar" ) 
        or warn SQL::Translator::Object::Schema::Index->error;
    $index2    = $person_table->add_index( $index2 );
    isa_ok( $index2, 'SQL::Translator::Object::Schema::Index', 'Index' );
    ...
    isa_ok($dropped_index, 'SQL::Translator::Object::Schema::Index', 'Dropped index "foo"' );
    $person_table->add_index($index1);
    my $dropped_index2 = $person_table->drop_index($index1);
    isa_ok($dropped_index2, 'SQL::Translator::Object::Schema::Index', 'Dropped index "foo" by object' );
    ...
    my $constraint1 = $person_table->add_constraint( name => 'foo' ) 
        or warn $person_table->error;
    isa_ok( $constraint1, 'SQL::Translator::Object::Schema::Constraint', 'Constraint' );
    ...
    my $constraint2 = SQL::Translator::Object::Schema::Constraint->new( name => 'bar' );
    $constraint2    = $person_table->add_constraint( $constraint2 );
    isa_ok( $constraint2, 'SQL::Translator::Object::Schema::Constraint', 'Constraint' );
    ...
    isa_ok( $constraint3, 'SQL::Translator::Object::Schema::Constraint', 'Constraint' );
    ...
    isa_ok($dropped_con, 'SQL::Translator::Object::Schema::Constraint', 'Dropped constraint "foo"' );
    $person_table->add_constraint($constraint1);
    my $dropped_con2 = $person_table->drop_constraint($constraint1);
    isa_ok($dropped_con2, 'SQL::Translator::Object::Schema::Constraint', 'Dropped constraint "foo" by object' );
    ...
    isa_ok( $view, 'SQL::Translator::Object::Schema::View', 'View' );
    my $view_sql = 'select * from table';
    is( $view->sql( $view_sql ), $view_sql, 'View SQL is good' );

    my $view2 = SQL::Translator::Object::Schema::View->new(name => 'view2') or
        warn SQL::Translator::Object::Schema::View->error;
    ...
    isa_ok($dropped_view, 'SQL::Translator::Object::Schema::View', 'Dropped view "view1"' );
    $schema->add_view($view);
    my $dropped_view2 = $schema->drop_view($view);
    isa_ok($dropped_view2, 'SQL::Translator::Object::Schema::View', 'Dropped view "view1" by object' );
    ...
    isa_ok( $good_view, 'SQL::Translator::Object::Schema::View', 'View "view1"' );
    is( $view->sql( $view_sql ), $view_sql, 'View SQL is good' );
...
#
{
    ...
    isa_ok( $c, 'SQL::Translator::Object::Schema::Constraint', 'Constraint' );
...
#
{
    ...
    isa_ok( $v, 'SQL::Translator::Object::Schema::View', 'View' );
    ...
    isa_ok( $v1, 'SQL::Translator::Object::Schema::View', 'View' );
...
#
{
    ...
    isa_ok( $t, 'SQL::Translator::Object::Schema::Trigger', 'Trigger' );
	...
	isa_ok( $t2, 'SQL::Translator::Object::Schema::Trigger', 'Trigger' );
    ...
    isa_ok($dropped_trig, 'SQL::Translator::Object::Schema::Trigger', 'Dropped trigger "foo_trigger"' );
    $s->add_trigger($t);
    my $dropped_trig2 = $s->drop_trigger($t);
    isa_ok($dropped_trig2, 'SQL::Translator::Object::Schema::Trigger', 'Dropped trigger "foo_trigger" by object' );
...
#
{
    ...
    isa_ok( $p, 'SQL::Translator::Object::Schema::Procedure', 'Procedure' );
    ...
    isa_ok( $p1, 'SQL::Translator::Object::Schema::Procedure', 'Procedure' );
    ...
    isa_ok($dropped_proc, 'SQL::Translator::Object::Schema::Procedure', 'Dropped procedure "foo_proc"' );
    $s->add_procedure($p);
    my $dropped_proc2 = $s->drop_procedure($p);
    isa_ok($dropped_proc2, 'SQL::Translator::Object::Schema::Procedure', 'Dropped procedure "foo_proc" by object' );
